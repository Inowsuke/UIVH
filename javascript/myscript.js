...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Bấm dô đâyyy đii " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nó cứ bùm bùm tại zì:';
document.querySelector('.Description .modal-body').innerHTML = 'Happy Valentine <i class="fas fa-heart"></i> ';
